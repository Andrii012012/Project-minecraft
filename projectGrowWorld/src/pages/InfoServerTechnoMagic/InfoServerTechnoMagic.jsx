...
import "./InfoServerTechnoMagic.css";
...
const INFO_SERVER = [
  ...
  { icon: "", info: 'Размер карты в аду":', aboutInfo: "5000 на 5000 блоков" },
  { icon: "", info: "Размер карты в эндер мире:", aboutInfo: "20000 на 20000" },
...
export default function InfoServerTechnoMagic(props) {
  ...
  return (
    <DescriptionServer
      imageMain={ImageMain}
      server="TechnoMagic"
      descriptionServer={` Давно искал сервер, на котором сможешь со своими друзьями стать
